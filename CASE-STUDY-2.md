...
| 12:10 | P4 merged into main locally (27c424d, not pushed); the seam test runs on the desktop on the combined P1+P4 tree, which no suite has run; the push waits for the box's suite at P4's staging commit; then the box runs the merged main. Six stated bench counts become twenty-five. |
